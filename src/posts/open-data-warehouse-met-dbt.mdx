...
export const meta = {
  ...
  date: '26 jul 2026',
  excerpt:
    'Dashboards falen zelden op de visualisatie en bijna altijd op het fundament eronder. Daarom bouw ik in de openbaarheid een warehouse op Nederlandse open data — met alles erop en eraan.',
}
...
{GITHUB_URL && (
  <p>
    <em>
      De volledige code en documentatie staan op{' '}
